...
![Testbed architecture: TRNG cluster, QKD datapath with the UWOC channel emulator, and the monitor/adaptive-control block]
...
│
├── Images/                       Paper figures (paper_figs_uwoc.py)
