// ============================================================
// PWM POWER CONTROLLER — laser power adjustment
// ============================================================
// power_level[3:0] = 0-15 → PWM duty cycle 0%-100%
// Frequency: ~50kHz (fast enough that the laser does not flicker)
//
// Used with a transistor: PWM → Base → Collector drives laser
// Higher duty cycle = brighter laser = stronger signal
// ============================================================
...
module pwm_power (
    ...
    // Output: signal AND pwm (laser ON only when both are HIGH)
    // When power_level = 15: pwm_high is always 1 → signal_out = signal_in
    // When power_level = 0:  pwm_high is always 0 → signal_out = 0
...
// ============================================================
// Instead of a fixed 50/50, allow biasing toward the Z-basis
...
//   230 = 90% Z
//
// Compare the LFSR output against a threshold → pick the basis
// ============================================================
