#!/usr/bin/env python3
"""
regen_paper_figs.py — Regenerate ALL figures for the paper
════════════════════════════════════════════════════════
...
Required in the same directory:
  - table2_data.csv         (from bb84_table2.py)
  - [optional] FPGA per-qubit data files if you want real data for Fig 3

Output (into the Images/ directory):
