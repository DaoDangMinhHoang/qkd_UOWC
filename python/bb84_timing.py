...
FPGA part: computed directly from the Verilog parameters (no board required)
MATLAB part: entered by hand after running the MATLAB timing script

Run:
  python bb84_timing.py                          # FPGA only
  python bb84_timing.py --matlab 45,120,38,5,2   # With MATLAB data (ms)
"""
